            ...
            return (createElement(Plugin, { name: pluginName },
                ...
                createElement(Template, { name: "series" },
                    ...
                    createElement(TemplateConnector, null, function (_a) {
                        ...
                        return (createElement(Path, { index: currentSeries.index, pointComponent: currentSeries.pointComponent, coordinates: currentSeries.points, rotated: rotated, state: currentSeries.state, color: currentSeries.color, scales: currentScales, getAnimatedStyle: getAnimatedStyle, pane: layouts.pane, clipPathId: clipPathId }));
                    }))));
        };
...
var RawArea = /*#__PURE__*/ (function (_super) {
    ...
    RawArea.prototype.render = function () {
        ...
        return (createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: dPath(coordinates), fill: color, opacity: 0.5, style: getAnimatedStyle(style, getAreaAnimationStyle, scales) }, restProps)));
    };
    return RawArea;
}(PureComponent));
...
var RawBar = /*#__PURE__*/ (function (_super) {
    ...
    RawBar.prototype.render = function () {
        ...
        return (createElement("rect", __assign({}, adjustedBar, { fill: color, visibility: visibility, style: getAnimatedStyle(style, getAreaAnimationStyle, scales) }, restProps)));
    };
    return RawBar;
}(PureComponent));
...
var RawPath = /*#__PURE__*/ (function (_super) {
    ...
    RawPath.prototype.render = function () {
        ...
        return (createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: path(coordinates), fill: "none", strokeWidth: 2, stroke: color, style: getAnimatedStyle(style, getAreaAnimationStyle, scales) }, restProps)));
    };
    return RawPath;
}(PureComponent));
...
var RawPoint = /*#__PURE__*/ (function (_super) {
    ...
    RawPoint.prototype.render = function () {
        ...
        return (createElement("path", __assign({ transform: "translate(" + x + " " + y + ")", d: dSymbol(pointOptions), fill: color, visibility: visibility, stroke: "none", style: getAnimatedStyle(style, getScatterAnimationStyle, scales) }, restProps)));
    };
    return RawPoint;
}(PureComponent));
