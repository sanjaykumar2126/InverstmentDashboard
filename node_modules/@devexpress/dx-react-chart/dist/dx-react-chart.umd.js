    ...
    ***************************************************************************** */
            ...
            Component.prototype.render = function () {
                ...
                return (React.createElement(dxReactCore.Plugin, { name: pluginName },
                    ...
                    React.createElement(dxReactCore.Template, { name: "series" },
                        React.createElement(dxReactCore.TemplatePlaceholder, null),
                        React.createElement(dxReactCore.TemplateConnector, null, function (_a) {
                            var series = _a.series, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, rotated = _a.rotated, layouts = _a.layouts, clipPathId = _a.clipPathId;
                            ...
                            return (React.createElement(Path, { index: currentSeries.index, pointComponent: currentSeries.pointComponent, coordinates: currentSeries.points, rotated: rotated, state: currentSeries.state, color: currentSeries.color, scales: currentScales, getAnimatedStyle: getAnimatedStyle, pane: layouts.pane, clipPathId: clipPathId }));
                        }))));
            };
    ...
    var RawArea = /*#__PURE__*/ (function (_super) {
        ...
        RawArea.prototype.render = function () {
            var _a = this.props, path = _a.path, coordinates = _a.coordinates, index = _a.index, state = _a.state, pointComponent = _a.pointComponent, color = _a.color, clipPathId = _a.clipPathId, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, rotated = _a.rotated, restProps = __rest(_a, ["path", "coordinates", "index", "state", "pointComponent", "color", "clipPathId", "style", "scales", "getAnimatedStyle", "rotated"]);
            var dPath = path === undefined ? (rotated ? dxChartCore.dRotateArea : dxChartCore.dArea) : path;
            return (React.createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: dPath(coordinates), fill: color, opacity: 0.5, style: getAnimatedStyle(style, dxChartCore.getAreaAnimationStyle, scales) }, restProps)));
        };
        return RawArea;
    }(React.PureComponent));
    ...
    var PointCollection = /*#__PURE__*/ (function (_super) {
        ...
        PointCollection.prototype.render = function () {
            var _a = this.props, pointComponent = _a.pointComponent, coordinates = _a.coordinates, index = _a.index, state = _a.state, clipPathId = _a.clipPathId, restProps = __rest(_a, ["pointComponent", "coordinates", "index", "state", "clipPathId"]) // restProps are used because of getAnimatedStyle and scale
            ;
    ...
    var RawBar = /*#__PURE__*/ (function (_super) {
        ...
        RawBar.prototype.render = function () {
            ...
            return (React.createElement("rect", __assign({}, adjustedBar, { fill: color, visibility: visibility, style: getAnimatedStyle(style, dxChartCore.getAreaAnimationStyle, scales) }, restProps)));
        };
        return RawBar;
    }(React.PureComponent));
    ...
    var RawPath = /*#__PURE__*/ (function (_super) {
        ...
        RawPath.prototype.render = function () {
            ...
            return (React.createElement("path", __assign({ clipPath: "url(#" + clipPathId + ")", d: path(coordinates), fill: "none", strokeWidth: 2, stroke: color, style: getAnimatedStyle(style, dxChartCore.getAreaAnimationStyle, scales) }, restProps)));
        };
        return RawPath;
    }(React.PureComponent));
    ...
    var RawPoint = /*#__PURE__*/ (function (_super) {
        ...
        RawPoint.prototype.render = function () {
            var _a = this.props, arg = _a.arg, val = _a.val, rotated = _a.rotated, argument = _a.argument, value = _a.value, seriesIndex = _a.seriesIndex, index = _a.index, state = _a.state, pointOptions = _a.point, color = _a.color, pane = _a.pane, style = _a.style, scales = _a.scales, getAnimatedStyle = _a.getAnimatedStyle, restProps = __rest(_a, ["arg", "val", "rotated", "argument", "value", "seriesIndex", "index", "state", "point", "color", "pane", "style", "scales", "getAnimatedStyle"]);
            var x = rotated ? val : arg;
            var y = rotated ? arg : val;
            var visibility = dxChartCore.getVisibility(pane, x, y, 0, 0);
            return (React.createElement("path", __assign({ transform: "translate(" + x + " " + y + ")", d: dxChartCore.dSymbol(pointOptions), fill: color, visibility: visibility, stroke: "none", style: getAnimatedStyle(style, dxChartCore.getScatterAnimationStyle, scales) }, restProps)));
        };
        return RawPoint;
    }(React.PureComponent));
