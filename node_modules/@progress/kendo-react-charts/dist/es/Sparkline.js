...
var Sparkline = /** @class */ (function (_super) {
    ...
    Sparkline.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, data = _a.data, type = _a.type, baseChartProps = __rest(_a, ["children", "data", "type"]);
        return (React.createElement(BaseChart, __assign({}, baseChartProps, { ref: function (baseChart) { return _this._baseChart = baseChart; }, chartConstructor: KendoSparkline, getTarget: this.getTarget, wrapper: "span", deriveOptionsFromParent: this.deriveOptionsFromParent, wrapperClassName: "k-sparkline k-widget" }), children));
    };
    return Sparkline;
}(React.Component));
export { Sparkline };
