...
var BaseChart = /** @class */ (function (_super) {
    ...
    BaseChart.prototype.getDirection = function (dir) {
        var _this = this;
        var directionFromWindow = function () { return !kendo_react_common_1.isServerRendering() && window.getComputedStyle(_this.element).direction; };
    ...
    BaseChart.prototype.getChartOptions = function () {
        var _a = this.props, renderAs = _a.renderAs, pannable = _a.pannable, zoomable = _a.zoomable, transitions = _a.transitions, seriesColors = _a.seriesColors, deriveOptionsFromParent = _a.deriveOptionsFromParent;
